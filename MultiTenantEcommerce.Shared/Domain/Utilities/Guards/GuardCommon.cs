...
namespace MultiTenantEcommerce.Shared.Domain.Utilities.Guards;
...
public static class GuardCommon
{
    ...
    {
        if (id == Guid.Empty) throw new ArgumentException(parameterName, $"{parameterName} cannot be empty GUID.");
    }
}